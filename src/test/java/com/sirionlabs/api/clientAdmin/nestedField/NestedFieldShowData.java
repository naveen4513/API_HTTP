...
public class NestedFieldShowData extends TestAPIBase {

    public static String getApiPath(int masterFieldId) {
        return "/nestedfield/showData/" + masterFieldId;
    }
    ...
    public static APIResponse getShowDataResponse(int masterFieldId) {
