...
public class SpecialEntityFieldEditPost extends TestAPIBase {

    public static String getApiPath() {
        return "/specialentityfield/v1/edit";
    }
    ...
    public static String getPayload(int specialEntityFieldId, String primaryEntityCustomFieldName, String primaryEntityCustomFieldId, Integer primaryEntityTypeId,
                                    Integer secondaryEntityTypeId, Map<String, String> secondaryEntityFieldsMap, Boolean active) {
        ...
        return "{\"body\": {\"data\": {\"primaryEntity\": {\"name\": \"primaryEntity\",\"id\": 12538,\"values\": {\"id\": " + primaryEntityTypeId +
                "}},\"id\": {\"name\": \"id\",\"values\": " + specialEntityFieldId + "},\"secondaryEntity\": {\"name\": \"secondaryEntity\",\"id\": 12536," +
                "\"values\": {\"id\": " + secondaryEntityTypeId + "}},\"secondaryEntityFields\": {\"name\": \"secondaryEntityFields\",\"id\": 12535,\"values\": " +
                secondaryEntityFieldsSubPayload + "},\"primaryEntityCustomField\": " + primaryEntityCustomFieldSubPayload +
                ",\"active\": {\"name\": \"active\",\"id\": 12542,\"values\": " + active + "}}}}";
    }

    public static APIResponse getUpdateResponse(String payload) {
