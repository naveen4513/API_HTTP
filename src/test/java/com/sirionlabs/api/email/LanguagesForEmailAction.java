...
public class LanguagesForEmailAction extends TestAPIBase {

    public static String getNewApiPath(String entityTypeId, String emailId) {

        return "/tblsystemEmailConfigurations/getLanguagesForEmailAction?entityTypeId="+entityTypeId+"&actionName="+emailId+"";
    }
