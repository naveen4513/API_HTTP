...
public class ClientDetailsAPI extends TestAPIBase {
    String queryString="/oauth/client/" ;
    ...
    public APIResponse getClientDetails(String OauthClientId) {
        String lastLoggedInUserName = Check.lastLoggedInUserName;
        String lastLoggedInUserPassword = Check.lastLoggedInUserPassword;
        AdminHelper adminHelper=new AdminHelper();
        adminHelper.loginWithClientAdminUser();
        queryString+=OauthClientId;
        APIResponse response= executor.get( queryString,getHeader()).getResponse();
