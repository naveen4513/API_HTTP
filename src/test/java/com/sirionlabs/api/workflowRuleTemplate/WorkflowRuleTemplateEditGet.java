...
public class WorkflowRuleTemplateEditGet extends TestAPIBase {

    public static String getApiPath(int workflowRuleTemplateId) {
        return "/workflowruletemplate/v1/edit/" + workflowRuleTemplateId;
    }
    ...
    public static APIResponse getEditGetResponse(int workflowRuleTemplateId) {
