package com.sirionlabs.dto.ValidateAccessToken;
...
public class ValidateAccessTokenDto {
    ...
    public ValidateAccessTokenDto(String testCaseId, String description, String header, String expectedStatusCode, String expectedResponseMessage) {
