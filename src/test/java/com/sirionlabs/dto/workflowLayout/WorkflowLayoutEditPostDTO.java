...
public class WorkflowLayoutEditPostDTO {
    ...
    public WorkflowLayoutEditPostDTO(String testCaseId, String description, int workflowLayoutId, String workflowLayoutGroupName, String editableFieldsShowPage,
                                     String editableFieldsEditPage, String editPageTabs, String showPageTabs, int entityTypeId, int expectedStatusCode,
