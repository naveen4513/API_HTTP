...
public class WorkflowLayoutShowDTO {
    ...
    public WorkflowLayoutShowDTO(String testCaseId, String description, int workflowLayoutId, int expectedStatusCode, String expectedErrorMessage) {
