...
public class WorkflowRuleTemplateShowDTO {
    ...
    public WorkflowRuleTemplateShowDTO(String testCaseId, String description, int workflowRuleTemplateId, int expectedStatusCode, String expectedErrorMessage) {
