...
public class TestCreateStateTask extends TestAPIBase {
    ...
    public void beforeClass() throws ConfigurationException {
        ...
        confmap = CreateTaskAPI.getAllConfigForCreateStateTaskAPI("envinfo");
    ...
    @Test
    public void createWFStateTaskAPITest() {
        ...
        try {
            flowmap = CreateTaskAPI.getAllConfigForCreateStateTaskAPI("flow1");
            stateId = flowmap.get("stateid");
            entityName = flowmap.get("entityname");
            stateName = flowmap.get("statename");

            taskName = flowmap.get("taskname") + createTaskAPI.randomNumberGenerator();
            String resolved_payload = createTaskAPI.getPayloadCreateStateTask(stateId, stateName, taskName, flowmap.get("entitytypeid"), entityName);
            ...
            logger.error("State task is not created successfully");
            e.printStackTrace();
        }
    }

    @Test
    public void createStateTaskSameNameAPITest() {
        CustomAssert csAssert = new CustomAssert();
        APIValidator validator;
        boolean statusFromResponse;
        String taskName;
        ...
        try {
            flowmap = CreateTaskAPI.getAllConfigForCreateStateTaskAPI("flow2");
            stateId = flowmap.get("stateid");
            entityName = flowmap.get("entityname");
            stateName = flowmap.get("statename");
