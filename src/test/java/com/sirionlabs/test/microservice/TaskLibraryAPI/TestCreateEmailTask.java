...
public class TestCreateEmailTask extends TestAPIBase {
    ...
    public void beforeClass() throws ConfigurationException {
        ...
        confmap = CreateTaskAPI.getAllConfigForCreateEmailTaskAPI("envinfo");
    ...
    @Test
    public void createWFEmailTaskAPITest() {
        ...
        try {
            flowmap = CreateTaskAPI.getAllConfigForCreateEmailTaskAPI("flow1");
            emailTemplateId = flowmap.get("emailtemplateid");
            entityName = flowmap.get("entityname");
            emailTemplateName = flowmap.get("emailtemplatename");

            taskName = flowmap.get("taskname") + createTaskAPI.randomNumberGenerator();
            String resolved_payload = createTaskAPI.getPayloadCreateEmailTask(emailTemplateId, emailTemplateName, taskName, flowmap.get("entitytypeid"), entityName);
            ...
            logger.error("Email task is not created successfully");
            e.printStackTrace();
        }
    }

    @Test
    public void createEmailTaskSameNameAPITest() {
        CustomAssert csAssert = new CustomAssert();
        APIValidator validator;
        boolean statusFromResponse;
        String taskName;
        ...
        try {
            flowmap = CreateTaskAPI.getAllConfigForCreateEmailTaskAPI("flow2");
            emailTemplateId = flowmap.get("emailtemplateid");
            entityName = flowmap.get("entityname");
            emailTemplateName = flowmap.get("emailtemplatename");
