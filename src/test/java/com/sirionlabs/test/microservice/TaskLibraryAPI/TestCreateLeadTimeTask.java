...
public class TestCreateLeadTimeTask extends TestAPIBase {
    ...
    public void beforeClass() throws ConfigurationException {
        ...
        confmap = CreateTaskAPI.getAllConfigForCreateLeadTimeTaskAPI("envinfo");
    ...
    @Test
    public void createWFLeadTimeTaskAPITest() {
        CustomAssert csAssert = new CustomAssert();
        APIValidator validator;
        boolean statusFromResponse;
        String taskName;
        String entityName;
        String leadTimeFieldId;
        String leadTimeFieldName;
        String errorMessage;
        String taskId;
        ...
        try {
            flowmap = CreateTaskAPI.getAllConfigForCreateLeadTimeTaskAPI("flow1");
            leadTimeFieldId = flowmap.get("leadtimefieldid");
            entityName = flowmap.get("entityname");
            leadTimeFieldName = flowmap.get("leadtimefieldname");

            taskName = flowmap.get("taskname") + createTaskAPI.randomNumberGenerator();
            String resolved_payload = createTaskAPI.getPayloadCreateLeadTimeTask(leadTimeFieldId, leadTimeFieldName, taskName, flowmap.get("entitytypeid"), entityName);
    ...
    @Test
    public void createLeadTimeTaskSameNameAPITest() {
        CustomAssert csAssert = new CustomAssert();
        APIValidator validator;
        boolean statusFromResponse;
        String taskName;
        ...
        try {
            flowmap = CreateTaskAPI.getAllConfigForCreateLeadTimeTaskAPI("flow2");
            leadTimeFieldId = flowmap.get("leadtimefieldid");
            entityName = flowmap.get("entityname");
            leadTimeFieldName = flowmap.get("leadtimefieldname");
