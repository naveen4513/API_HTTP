...
public class Test_BulkCreateInvoiceV2_NegativeScenarios {

    private final static Logger logger = LoggerFactory.getLogger(Test_BulkCreateInvoiceV2_NegativeScenarios.class);
                    ...
                    if (fieldIdNameMap.containsKey(columnId)) {
                        ...
                        if (!fieldName.contains("dyn")) {
                            ...
                            if (!(actualShowPageValue.contains(expectedColumnValue) || expectedColumnValue.contains(actualShowPageValue))) {
                                customAssert.assertTrue(false, "After Bulk Create Show Page Field " + fieldName + " not matched with expected Value");
                            }
                        } else {
