...
import com.sirionlabs.api.workflowRuleTemplate.WorkflowRuleTemplateEditGet;
import com.sirionlabs.dto.workflowRuleTemplate.WorkflowRuleTemplateEditGetDTO;
...
public class TestWorkflowRuleTemplateEditGetAPI {

    private final static Logger logger = LoggerFactory.getLogger(TestWorkflowRuleTemplateEditGetAPI.class);
    ...
    public Object[][] dataProviderJson() throws IOException {
        ...
        String dataFileName = "workflowRuleTemplateEditGetAPIData.json";

        List<WorkflowRuleTemplateEditGetDTO> dtoObjectList = new ArrayList<>();
        ...
        for (int i = 0; i < jsonArr.length(); i++) {
            ...
            if (jsonObj.getString("enabled").trim().equalsIgnoreCase("yes")) {
                if (jsonObj.getString("testingType").trim().toLowerCase().contains(testingType.toLowerCase())) {
                    WorkflowRuleTemplateEditGetDTO dtoObject = getEditGetDTOObjectFromJson(jsonObj);
        ...
        for (WorkflowRuleTemplateEditGetDTO dtoObject : dtoObjectList) {
    ...
    private WorkflowRuleTemplateEditGetDTO getEditGetDTOObjectFromJson(JSONObject jsonObj) {
        WorkflowRuleTemplateEditGetDTO dtoObject = null;
        ...
        try {
            ...
            dtoObject = new WorkflowRuleTemplateEditGetDTO(testCaseId, description, ruleTemplateId, expectedStatusCode, expectedErrorMessage);
        } catch (Exception e) {
            logger.error("Exception while Getting WorkflowRuleTemplateEditGet DTO Object. {}", e.getMessage());
        }
        return dtoObject;
    }

    @Test(dataProvider = "dataProviderJson")
    public void testWorkflowRuleTemplateEditGetAPI(WorkflowRuleTemplateEditGetDTO dtoObject) {
        ...
        try {
            ...
            APIResponse response = WorkflowRuleTemplateEditGet.getEditGetResponse(dtoObject.getWorkflowRuleTemplateId());
            ...
            if (expectedErrorMessage == null) {
                ...
                if (ParseJsonResponse.validJsonResponse(responseBody)) {
                    ...
                    csAssert.assertTrue(false, "Workflow Rule Template Edit Get API Response for Rule Template Id: " +
