 ...
 public class TestUserCreationSirionlabsTypeUser extends TestAPIBase {

    private final static Logger logger = LoggerFactory.getLogger(TestUserCreationSirionlabsTypeUser.class);
