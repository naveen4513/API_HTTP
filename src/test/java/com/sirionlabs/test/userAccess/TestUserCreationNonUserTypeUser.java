 ...
 public class TestUserCreationNonUserTypeUser extends TestAPIBase {

    private final static Logger logger = LoggerFactory.getLogger(TestUserCreationNonUserTypeUser.class);
