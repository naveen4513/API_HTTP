 ...
 public class TestUserCreationSupplierTypeUser extends TestAPIBase {

    private final static Logger logger = LoggerFactory.getLogger(TestUserCreationSupplierTypeUser.class);
