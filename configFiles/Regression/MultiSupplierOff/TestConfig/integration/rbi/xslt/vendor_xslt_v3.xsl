...
xmlns:xs="http://www.w3.org/2001/XMLSchema">
    ...
    <xsl:template match="/">
        ...
        <xsl:for-each select="vendors/vendor">
            ...
            "clientPrimaryKey": "<xsl:value-of select="H_ATTRIBUTE3"/>"
            },
            "otherInfo": {
            "rawFile": {}
            },
            ...
            "fieldValue": {
            "type": "TEXT",
            "value": "<xsl:value-of select="translate(H_ATTRIBUTE3,  ' ', '')"/>"
            }
            },
            {
            "id": 6007,
            ...
            "fieldValue": {
            "type": "TEXT",
            "value": "<xsl:value-of select="substring(translate(H_ATTRIBUTE3, ' ',''), 0, 6)"/>"
            }
            },
            {
            "id": 6000,
            ...
            "fieldValue": {
            "type": "TEXT",
            "value": "<xsl:value-of select="H_ATTRIBUTE3"/>"
            }
            },
            {
            "id": 6002,
